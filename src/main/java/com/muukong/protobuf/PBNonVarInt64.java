...
/**
 * Represents a NonVarInt64 as defined in https://protobuf.dev/programming-guides/encoding/#non-varints
 */
public class PBNonVarInt64 implements ISerializable, IParseable {

    private final static int FIELD_VALUE_LENGTH = 8;

    private byte[] value;

    public PBNonVarInt64(long value) {
    ...
    public PBNonVarInt64(byte[] value) {
    ...
    public String prettyPrint(String indent) {
        ...
        return String.format("%s%di64", indent, result);
    }
    ...
    public byte[] serializeValueWithFieldNumber(int fieldNumber) {
        ...
        long tag = ((long)fieldNumber << 3) | PBWireTypes.I64;
